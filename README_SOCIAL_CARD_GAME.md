...
本项目提供两个版本：
- **Web版** (`index.html`) - 适合桌面浏览器使用
- **移动APP版** (`app.html`) - 游戏化设计，适合手机使用
...
**快速体验移动版**：运行后访问 http://localhost:8000/app.html

**打包成原生APP**：参考 [README_MOBILE_APP.md](README_MOBILE_APP.md)
